...
//
//         logger.info(`
//                 Created booking for user ${userId} in room ${booking.roomId} from ${startDate} to ${endDate} with booking id ${booking.id} for ip ${req.ip}`, 
//                 { 
//                     data: 
//                         { 
//                             userId, 
...
export { getBookingById, getAllBookings };
