...
const HotelCard = (props: HotelCardProps) => {
    ...
    return (
        <div className="font-[Inter] flex gap-10 w-full">
            <img className="h-60 rounded-xl" src={props.imageSrc} />

            <div className= "flex flex-col gap-3 justify-between items-start">
                <p className="text-sm text-gray-500">{props.locationHotel}</p>
                <p className="text-lg font-Playfair">{props.name}</p>
                ...
                <div className="grid grid-cols-[auto_auto_auto] gap-x-3 gap-y-3 full max-xl:grid-cols-[auto_auto] max-xl:grids-rows-2">
