    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(handleSignUp)} className="flex flex-col gap-3 w-full">
                ...
                <Input {...register("email")} required error={errors.email} type="text" placeholder="Email address" text="Email address"/>

                <div className="flex gap-5">
                    <Input {...register("firstName")} required error="" type="text" placeholder={"First Name"} text="First Name"/>
                    <Input {...register("lastName")} required error="" type="text" placeholder="Last Name" text="Last Name"/>
                </div>

                <SelectBox items={country_list} defaultValue="Egypt" title="Select Country" text="Country"/>

                {/* Todo: Implement password for this*/}
                <Input {...register("password")} required error={errors.password} type="text" placeholder="Password" text="Password"/>
