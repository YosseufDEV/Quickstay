    ...
    return (
        <header ref={ref} className={styles.header}>
            ...
            <div className={ `flex flex-row gap-7.5 h-max items-center justify-center` }>
                ...
                {isAuthenticated ? <UserIcon className="stroke-red header-icon w-8 h-8 cursor-pointer"/> : <GenericButton onClick={handleLoginButtonClick} text="Login" className="rounded-[35px]! w-25 bg-black! text-white! outline-none! text-[17px]!"/> }
            </div>
        </header>
    )
}
